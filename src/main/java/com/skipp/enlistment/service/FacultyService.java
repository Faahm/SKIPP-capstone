...
public interface FacultyService {
    ...
    /**
     * Returns a single Faculty record matching the given facultyNumber.
     * <p>
     ...
     * @return a Faculty record with the details of the faculty, with or without sections associated
     */
